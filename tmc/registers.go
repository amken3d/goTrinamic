...
type DRVSTATUS_Register struct {
	Register
...
func NewDRVSTATUS() *DRVSTATUS_Register {
	return &DRVSTATUS_Register{
		Register: Register{
			RegisterAddr: DRVSTATUS,
		},
	}
}

// Pack method for DRV_STATUS: overrides the base Pack
func (d *DRVSTATUS_Register) Pack() uint32 {
	var registerValue uint32
...
func (d *DRVSTATUS_Register) Unpack(registerValue uint32) {
	// Unpack each field using bitwise operations
